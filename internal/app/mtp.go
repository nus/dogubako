...
var (
	eventMTPRefresh    = guigui.GenerateEventKey()
	eventMTPUp         = guigui.GenerateEventKey()
...
type MTPTool struct {
	...
	header   mtpFileHeader
	fileList basicwidget.List[string]
	rows     guigui.WidgetSlice[*mtpFileRow]
...
func (t *MTPTool) WriteStateKey(context *guigui.Context, w *guigui.StateKeyWriter) {
...
func (t *MTPTool) OnRefresh(f func(context *guigui.Context)) {
	guigui.SetEventHandler(t, eventMTPRefresh, f)
}
func (t *MTPTool) OnUp(f func(context *guigui.Context)) {
	guigui.SetEventHandler(t, eventMTPUp, f)
}
func (t *MTPTool) OnPull(f func(context *guigui.Context)) {
	guigui.SetEventHandler(t, eventMTPPull, f)
}
func (t *MTPTool) OnPushFile(f func(context *guigui.Context)) {
	guigui.SetEventHandler(t, eventMTPPushFile, f)
}
...
func (t *MTPTool) handleColResize(context *guigui.Context, bounds image.Rectangle, hitTest bool) guigui.HandleInputResult {
...
func (t *MTPTool) colResizeCursor(context *guigui.Context, widgetBounds *guigui.WidgetBounds) (ebiten.CursorShapeType, bool) {
	if t.colDrag != 0 {
...
func (t *MTPTool) CursorShape(context *guigui.Context, widgetBounds *guigui.WidgetBounds) (ebiten.CursorShapeType, bool) {
	if t.colDrag != 0 {
		return ebiten.CursorShapeEWResize, true
	}
	return 0, false
...
func (t *MTPTool) HandlePointingInput(context *guigui.Context, widgetBounds *guigui.WidgetBounds) guigui.HandleInputResult {
	if t.colDrag == 0 {
		return guigui.HandleInputResult{}
	}
...
func (t *MTPTool) Build(context *guigui.Context, adder *guigui.ChildAdder) error {
	...
	t.deviceLabel.SetValue(i18n.T(lang, i18n.MTPDevices))
	...
	t.refreshBtn.SetText(i18n.T(lang, i18n.MTPRefresh))
	t.refreshBtn.OnDown(func(context *guigui.Context) {
		guigui.DispatchEvent(t, eventMTPRefresh)
	})
	context.SetEnabled(&t.refreshBtn, !busy)

	t.upBtn.SetText(i18n.T(lang, i18n.MTPUp))
	t.upBtn.OnDown(func(context *guigui.Context) {
		guigui.DispatchEvent(t, eventMTPUp)
	})
	...
	t.hint.SetValue(i18n.T(lang, i18n.MTPHint))
	...
	t.pullBtn.OnDown(func(context *guigui.Context) {
		guigui.DispatchEvent(t, eventMTPPull)
	})
	context.SetEnabled(&t.pullBtn, !busy && online && model.HasSelection())

	t.pushFile.SetText(i18n.T(lang, i18n.MTPPushFile))
	t.pushFile.OnDown(func(context *guigui.Context) {
		guigui.DispatchEvent(t, eventMTPPushFile)
	})
	context.SetEnabled(&t.pushFile, !busy && model.CanPush())

	t.pushDir.SetText(i18n.T(lang, i18n.MTPPushFolder))
	t.pushDir.OnDown(func(context *guigui.Context) {
		guigui.DispatchEvent(t, eventMTPPushFolder)
	})
	context.SetEnabled(&t.pushDir, !busy && model.CanPush())
...
func (t *MTPTool) Layout(context *guigui.Context, widgetBounds *guigui.WidgetBounds, layouter *guigui.ChildLayouter) {
	u := basicwidget.UnitSize(context)
...
func (h *mtpFileHeader) SetLang(lang i18n.Lang, sortCol int, sortDesc bool) {
	h.name.SetValue(i18n.T(lang, i18n.MTPColName) + androidSortMark(androidSortName, sortCol, sortDesc))
	h.size.SetValue(i18n.T(lang, i18n.MTPColSize) + androidSortMark(androidSortSize, sortCol, sortDesc))
	h.mod.SetValue(i18n.T(lang, i18n.MTPColModified) + androidSortMark(androidSortMod, sortCol, sortDesc))
}

func (h *mtpFileHeader) Build(context *guigui.Context, adder *guigui.ChildAdder) error {
...
func (h *mtpFileHeader) layoutRow(context *guigui.Context) guigui.LinearLayout {
	u := basicwidget.UnitSize(context)
...
func (h *mtpFileHeader) Layout(context *guigui.Context, widgetBounds *guigui.WidgetBounds, layouter *guigui.ChildLayouter) {
	if h.tool != nil {
...
func (h *mtpFileHeader) Measure(context *guigui.Context, constraints guigui.Constraints) image.Point {
	return h.layoutRow(context).Measure(context, constraints)
}

func (h *mtpFileHeader) Draw(context *guigui.Context, widgetBounds *guigui.WidgetBounds, dst *ebiten.Image) {
	if h.tool == nil {
		return
	}
...
func (h *mtpFileHeader) CursorShape(context *guigui.Context, widgetBounds *guigui.WidgetBounds) (ebiten.CursorShapeType, bool) {
	if h.tool == nil {
		return 0, false
	}
...
func (h *mtpFileHeader) HandlePointingInput(context *guigui.Context, widgetBounds *guigui.WidgetBounds) guigui.HandleInputResult {
	if h.tool == nil {
		return guigui.HandleInputResult{}
	}
...
func (h *mtpFileHeader) handleSortClick(context *guigui.Context, bounds image.Rectangle, hit bool) guigui.HandleInputResult {
	u := basicwidget.UnitSize(context)
	cx, _ := ebiten.CursorPosition()
	sizeW, modW := h.tool.colWidths(u)
	...
	if moved <= slop {
		if v, ok := context.Env(h, EnvKeyModel); ok {
			v.(*Model).MTP().ToggleSort(col)
		}
	}
	return guigui.HandleInputByWidget(h)
}

type mtpFileRow struct {
	guigui.DefaultWidget
...
func (r *mtpFileRow) Set(row MTPTreeRow, onExpand func(), tool *MTPTool) {
	r.tool = tool
	r.depth = row.Depth
...
func (r *mtpFileRow) Build(context *guigui.Context, adder *guigui.ChildAdder) error {
	if r.isDir {
...
func (r *mtpFileRow) layoutRow(context *guigui.Context) guigui.LinearLayout {
	u := basicwidget.UnitSize(context)
	sizeW, modW := androidDefaultSizeCol(u), androidDefaultModCol(u)
	if r.tool != nil {
...
func (r *mtpFileRow) Layout(context *guigui.Context, widgetBounds *guigui.WidgetBounds, layouter *guigui.ChildLayouter) {
	var clr color.Color
...
func (r *mtpFileRow) Measure(context *guigui.Context, constraints guigui.Constraints) image.Point {
	u := basicwidget.UnitSize(context)
...
func (r *mtpFileRow) CursorShape(context *guigui.Context, widgetBounds *guigui.WidgetBounds) (ebiten.CursorShapeType, bool) {
	if r.tool == nil {
		return 0, false
	}
...
func (r *mtpFileRow) HandlePointingInput(context *guigui.Context, widgetBounds *guigui.WidgetBounds) guigui.HandleInputResult {
	if r.tool == nil {
		return guigui.HandleInputResult{}
	}
